...
$db=new Db("localhost","root","","crudtrial");
//echo "<pre>";
//print_r($db->getAll("students","*"));
//print_r($db->getById("students","*","id=2"));

//echo $db->getTable($db->getAll("students","name,address"));
//echo $db->getSingleTable($db->getById("students","*","id=2"));